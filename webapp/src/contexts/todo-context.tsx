...
import type { Todo, TodoInput, TodoUpdate } from '@template-ware/shared';
import { TodoMutator } from '@template-ware/shared/mutators';
...
export function TodoProvider({ children }: TodoProviderProps) {
  ...
  useEffect(() => {
    if (isAuthenticated && todoMutator) {
      // Sync todos to the authenticated user: fetch the initial list and open
      // the realtime subscription. Both manage their own loading/connection
      // state, so the synchronous setState warning does not apply here.
