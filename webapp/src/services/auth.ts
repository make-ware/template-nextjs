...
import type { User, RegisterData } from '@template-ware/shared';
import type { TypedPocketBase } from '@/lib/types';
import { parseAuthError, withRetry } from '@template-ware/shared';
import { UserMutator } from '@template-ware/shared/mutators';
